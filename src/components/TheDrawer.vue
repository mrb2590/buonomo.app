<template>
    ...
    >
      ...
      <v-list v-if="signedIn" class="pb-0" dense>
...
.the-drawer .v-list__tile__action .v-icon,
.the-drawer /deep/ .v-list__group__header__prepend-icon .v-icon {
  font-size: 20px;
}

// .the-drawer /deep/ .nav-toggle {
//   font-size: 16px;
// }
</style>
